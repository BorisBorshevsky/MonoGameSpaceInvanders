...
namespace Infrastructure
{
    ...
    public class AnimatedSpriteText : Sprite
    {
        ...
        {
            m_SpriteBatch.DrawString(m_FontSprite, displayText(), m_Position, this.TintColor, this.Rotation, this.RotationOrigin, this.Scales, SpriteEffects.None, this.LayerDepth);
        }
